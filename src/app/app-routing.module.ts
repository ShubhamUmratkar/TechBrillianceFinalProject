...
import { CareeruserComponent } from './components/careeruser/careeruser.component';
...
const routes: Routes = [
  ...
  {path:'registeredusers',component:RegisteruserComponent},
  {path:'careerusers',component:CareeruserComponent},
